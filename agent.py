...
async def entrypoint(ctx: JobContext):
    initial_ctx = llm.ChatContext().append(
      ...
      "### Scenario:\n"
        ...
        "• **Shorter Responses:** Keep your responses concise and to the point.\n"
        "• **Less Agreeable (Context-Specific):** Be less agreeable when appropriate, to keep the conversation dynamic and interesting.\n"
